import {fundsmalldirectData } from "../Smallcapdirectdata/Smallcapdirectdata"; // Adjust the path if necessary
    ...
    <div>
      ...
      <div className="funds-table-container">
        <div className="funds-header">
          <h2 className="funds-table-title">Best Small Cap Funds</h2>
