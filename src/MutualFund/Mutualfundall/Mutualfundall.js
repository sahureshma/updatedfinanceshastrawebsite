...
import MutualFundsSchemeAllocation from '../MutualFundSchemeAllocation/MutualFundSchemeAllocation';
import MtuFundDetails from '../MtuFundDetails/MtuFundDetails';
import FundContactInfo from '../../FundContactInfo/FundContactInfo';
import RiskOMeter from '../Fundriskometer/Fundriskometer';
...
function Mutualfund() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setFinancialData({
        price: `₹${newPrice}`,  // Correct interpolation
        percentage: `${newPercentage > 0 ? "+" : ""}${newPercentage}%`,  // Correct interpolation
